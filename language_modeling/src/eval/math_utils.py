"""
Helper functions to evaluate the models in MATH500: parser functions.
cloned from https://github.com/hendrycks/math/blob/main/modeling/dataset/util.py 
and https://github.com/hendrycks/math/blob/main/modeling/math_equivalence.py (the original repo for MATH dataset).
"""
...
# returns true or false, based on the exact match of the strings.
